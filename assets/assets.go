...
func pluginsCodeampGraphqlSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/codeamp/graphql/schema.graphql", size: 10304, mode: os.FileMode(420), modTime: time.Unix(1561661057, 0)}
